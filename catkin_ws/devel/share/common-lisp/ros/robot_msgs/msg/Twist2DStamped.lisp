...
(cl:defmethod cl:initialize-instance :after ((m <Twist2DStamped>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Twist2DStamped)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot_msgs-msg:<Twist2DStamped> is deprecated: use robot_msgs-msg:Twist2DStamped instead.")))
...
(cl:defmethod v-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:v-val is deprecated.  Use robot_msgs-msg:v instead.")
  (v m))

(cl:ensure-generic-function 'omega-val :lambda-list '(m))
(cl:defmethod omega-val ((m <Twist2DStamped>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot_msgs-msg:omega-val is deprecated.  Use robot_msgs-msg:omega instead.")
  (omega m))
